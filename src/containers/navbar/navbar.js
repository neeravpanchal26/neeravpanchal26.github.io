        ...
        return (
            ...
            <div>
                ...
                <ul className="sidenav" id="sideNav">
                    ...
                    <li>
                        <NavLink to="/">
                            <i><MdHome className='black-text'/></i>
                            Home
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/about">
                            <i><MdInfo className='black-text'/></i>
                            About
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/timeline">
                            <i><MdTimeline className='black-text'/></i>
                            Timeline
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/portfolio">
                            <i><MdWork className='black-text'/></i>
                            Portfolio
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/contact">
                            <i><MdPhone className='black-text'/></i>
                            Contact
                        </NavLink>
                    </li>
                </ul>
